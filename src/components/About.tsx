            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed text-justify">
                        ...
                        I work end to end—taking features from system design through
                        implementation to production readiness and day-to-day operation.
                        Over this time, I’ve personally authored and maintained{" "}
                        <strong>54K+ lines of production Java code</strong> across{" "}
                        <strong>100+ REST APIs</strong> and{" "}
                        <strong>250+ internal services and components</strong>, with a strong
                        focus on performance, reliability, and observability. Alongside
                        hands-on development, I regularly help drive backend execution by
                        breaking down work, mentoring teammates, and unblocking delivery,
                        while remaining a deeply involved individual contributor.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
                    {highlights.map((item, index) => (
                        <Card
                            key={index}
                            className="p-6 hover:shadow-elegant transition-smooth border-border hover:border-primary/30 animate-fade-in text-justify"
